...
def run():
	...
	points = genfromtxt('C:\\Users\\Aman Deep Singh\\Documents\\Python\\Practical ML\\student_data.csv', delimiter=',')
	# hyperparameters
	...
	print("The optimal intercept is: ", b)
	print("The optimal slope is: ", m)
